...
<template>
  <el-card class="box-card" v-loading="detailLoading">
    <el-tabs v-model="activeName">
      <el-tab-pane label="回放详情" name="first">
        <el-form class="demo-ruleForm">
          ...
          <el-card class="box-card">
            ...
            <el-row :gutter="20">
              <el-col :span="8">
                <el-form-item label="状态：">{{ replayCode }}</el-form-item>
              </el-col>
              ...
              <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                  <el-tooltip placement="right" style="margin-left: 1%">
                    ...
                    <el-button type="text" size="mini" @click="getIgnorePath(scope.row.path, 2)">忽略对比</el-button>
                  </el-tooltip>
                </template>
              </el-table-column>
            </el-table>
          ...
          <el-card>
            ...
            <el-form inline class="subCallForm">
              <el-form-item label="接口：" style="marginRight: 50px;">
          ...
          <el-form class="demo-ruleForm">
            <el-card class="box-card">
              ...
              <el-row :gutter="20">
                ...
                <el-col :span="12" class="red" v-if="dialogReplayStatus != 0">
            ...
            <el-card class="box-card" v-if="dialogReplayStatus != 3">
              ...
              <el-table :data="diaLogParameterArray" max-height="500">
                <el-table-column label="原始参数值" prop="value" align="center" show-overflow-tooltip :formatter="formatTableTDBlank">
                  <template slot-scope="scope">
                    <el-tooltip placement="top" effect="dark">
                ...
                <el-table-column label="回放参数值" prop="mockValue" align="center" show-overflow-tooltip :formatter="formatTableTDBlank">
                  <template slot-scope="scope">
                    <el-tooltip placement="top" effect="dark">
                ...
                <el-table-column label="原始参数类型" prop="type" align="center" width="120px" show-overflow-tooltip :formatter="formatTableTDBlank"/>
      ...
      <el-tab-pane label="java流量详情" name="third">
        <v-java-flow :traceId="recordTraceId" :taskRunId="recordTaskRunId" :closeType="2" :key="recordTraceId">
        </v-java-flow>
      </el-tab-pane>
    </el-tabs>
  </el-card>
...
import vJavaFlow from '../components/javaFlowDetail'
    ...
    getDetail() {
      ...
      API.playback.getReplayDataDetail(params).then((res) => {
        if (res.code === 'SUCCESS') {
          ...
          this.currentUriId = res.data.currentUriId
          ...
          this.originEntranceInvocation.request = res.data.originEntranceInvocation.request || []
        ...
        this.detailLoading = false
        this.$message.error('获取dubbo详情失败:' + err.msg)
      })
    },
