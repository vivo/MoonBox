...
<template>
  <el-card class="box-card" v-loading="detailLoading">
    <el-tabs v-model="activeName">
      ...
      <el-tab-pane label="dubbo流量详情" name="third">
        <v-dubbo-flow :traceId="recordTraceId" :taskRunId="recordTaskRunId" :closeType="2" :key="recordTraceId">
        </v-dubbo-flow>
      </el-tab-pane>
    </el-tabs>
  </el-card>
...
import vDubboFlow from '../components/dubboFlowDetail'
