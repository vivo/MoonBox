...
public class JavaLocalDatePlugin extends AbstractInvokePluginAdapter {
    /**
    ...
    protected List<EnhanceModel> getEnhanceModels() {
        ...
        EnhanceModel em = EnhanceModel.builder()
                .classPattern("java.time.LocalDate")
    ...
    @Override
    protected JavaLocalDateListener getEventListener(InvocationListener listener) {
        return new JavaLocalDateListener(getType(), isEntrance(), listener, getInvocationProcessor());
    }
    ...
    public static class JavaLocalDateListener extends DefaultEventListener {

        public JavaLocalDateListener(InvokeType invokeType, boolean entrance, InvocationListener listener, InvocationProcessor processor) {
        ...
        protected boolean access(Event event) throws Exception {
            if (MoonboxContext.getInstance().isRepeatMode() && event instanceof BeforeEvent && MoonboxRepeatCache.isRepeatFlow()) {
                ...
                ProcessControlException.throwReturnImmediately(localDate);
            }
