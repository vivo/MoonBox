...
public class RepeatMeta implements java.io.Serializable {
     ...
     */
    private MockStrategy.StrategyType strategyType;
    /**
     * 回放ID
     */
    ...
    public MockStrategy.StrategyType getStrategyType() {
        return strategyType;
    }

    public void setStrategyType(MockStrategy.StrategyType strategyType) {
