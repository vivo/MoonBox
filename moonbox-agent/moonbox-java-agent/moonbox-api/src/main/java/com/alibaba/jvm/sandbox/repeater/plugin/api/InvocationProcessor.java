...
public interface InvocationProcessor extends InvocationFilter {
     ...
     * @return
     */
    String assembleResponseType(Event event);
     ...
     */
    void doMock(BeforeEvent event, Boolean entrance, InvokeType type, Boolean recordStackTraces) throws ProcessControlException;
