...
public class SpringContextAdapter {
    ...
    public static Object getBeanByName(String beanName) {
        return SpringContextInnerContainer.isAgentLaunch() ? SpringContextInnerContainer.getBeanByName(beanName) : getBeanByNameFromContainer(beanName);
    }
    ...
    public static Object getBeanByType(String className) {
        return SpringContextInnerContainer.isAgentLaunch() ? SpringContextInnerContainer.getBeanByType(className) : getBeanByTypeFromContainer(className);
    }
    ...
    private static Object getBeanByNameFromContainer(String beanName) {
        ...
        try {
            ...
            MOONBOX_CONTEXT.exceptionOverflow(e);
            return null;
        }
    }
