 ...
 */
package com.vivo.jvm.sandbox.moonbox.module.classloader;
    ...
    enum Matcher {
        ...
        PLUGIN("plugin") {
            ...
            public boolean match(String identity) {
                return MOONBOX_CONTEXT.getConfig().getPluginIdentities().contains(identity);
            }

            @Override
            public void notFoundAction(String identity) {
                MOONBOX_CONTEXT.getConfig().getPluginIdentities().remove(identity);
            }
        },
        ...
        REPEATER("repeater") {
            @Override
            public boolean match(String identity) {
                return MOONBOX_CONTEXT.getConfig().getRepeatIdentities().contains(identity);
            }

            @Override
            public void notFoundAction(String identity) {
                MOONBOX_CONTEXT.getConfig().getRepeatIdentities().remove(identity);
            }
        };
